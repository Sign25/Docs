...
> **Примечание (Март 2026):** Ниже описана архитектура интеграции через chat-агента. Фактическая реализация использует **standalone-страницу** `/office`. Страница представляет единый дашборд без вкладок.
>
