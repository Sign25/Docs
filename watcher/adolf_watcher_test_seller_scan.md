...
**Открытие новых вкладок** (раз в 25-50 товаров):
...
**Случайное открытие Ozon/YM для сравнения** (раз в 60-100 товаров):
...
| Тип | Срабатываний | Среднее время | Итого |
|-----|:------------:|:-------------:|:-----:|
| Просмотр карточки (раз в 5-15) | 20 | 32 сек | 640 сек |
| Длинная пауза (раз в 30-60) | 4 | 120 сек | 480 сек |
| Эмуляция другого приложения (раз в 40-80) | 3 | 60 сек | 180 сек |
| Hover без клика (раз в 3-8) | 40 | 5 сек | 200 сек |
| Корзина (раз в 30-60) | 4 | 40 сек | 160 сек |
| Навигация WB (раз в 50-80) | 3 | 45 сек | 135 сек |
| Открытие новых вкладок (раз в 25-50) | 5 | 20 сек | 100 сек |
| Фокус/расфокус (раз в 15-30) | 9 | 10 сек | 90 сек |
| Фильтры/сортировка (раз в 20-40) | 7 | 12 сек | 84 сек |
| Переключение вкладок (раз в 10-20) | 13 | 5 сек | 65 сек |
| Поиск (раз в 40-70) | 4 | 15 сек | 60 сек |
| Избранное (раз в 15-30) | 9 | 6 сек | 54 сек |
| Сравнение на Ozon/YM (раз в 60-100) | 3 | 15 сек | 45 сек |
| Микроповедение (текст, клики) | 12 | 3 сек | 36 сек |
| **Итого отвлечения** | | | **~39 мин** |
...
| **Подытог** | **101.5 мин** |
| × усталость (×1.3) | **~132 мин** |
| **На 1 продавца** | **~2.2 часа** |

### Пропускная способность за ночь (12 часов)

| Размер каталога | Время на продавца | Продавцов за ночь |
|:---------------:|:-----------------:|:-----------------:|
| 50 товаров | ~40 мин | ~18 |
| 100 товаров | ~70 мин | ~10 |
| 200 товаров | ~132 мин | ~5 |
| 500 товаров | ~320 мин | ~2 |
| 1000 товаров | ~640 мин | ~1 |

### Типовой сценарий смешанной нагрузки

| Продавец | Товаров | Время |
|----------|:-------:|:-----:|
| Конкурент A | 300 | ~195 мин |
| Конкурент B | 150 | ~100 мин |
| Конкурент C | 100 | ~70 мин |
| Конкурент D | 80 | ~58 мин |
| Конкурент E | 50 | ~40 мин |
| **Итого** | **680** | **~463 мин (~7.7 ч)** |
| **Буфер** | | **~4.3 часа** |

Буфер ~4.3 часа — запас на CAPTCHA, нестабильный интернет, непредвиденные задержки.
