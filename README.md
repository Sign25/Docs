...
| **Watcher** | Мониторинг цен и действий конкурентов | v4.0 | 11 |
...
| **1Cexport** | Интеграция 1С:КА 2 → PostgreSQL (таблицы `1C_*`) | v1.0 | 4 |
| **CFO** | Финансовая отчётность и аналитика | v2.0 | 7 |
...
Документация проекта **Neurocore** (Нейро-Эволюционный Конструктор) — система синтетической биологии для цифровых организмов.

```
neurocore/
└── evolution_process.md    # Полный цикл нейро-эволюции
```
