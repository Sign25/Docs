# ADOLF MARKETING â€” Ð Ð°Ð·Ð´ÐµÐ» 4: Open WebUI
...
> **Примечание (Март 2026):** Ниже описана архитектура интеграции через chat-агента. Фактическая реализация использует **standalone-страницу** `/marketing`. Структура страницы:
>
> | Вкладка | Описание |
> |---------|----------|
> | Дашборд | Общая сводка |
> | Кампании | Управление рекламными кампаниями |
> | Ключевые слова | Управление ключевыми словами |
> | Safety Logic | Логика безопасности ставок |
> | AI-рекомендации | Рекомендации AI |
>
