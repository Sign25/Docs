# ADOLF v4.3 — ОБЩЕЕ ОПИСАНИЕ СИСТЕМЫ
...
| `@Adolf_Shop` | Управление интернет-магазином | Senior+ |
| `@Adolf_Office` | Дашборд AI-агентов | Director+ |
| `@Adolf_Logistic` | Логистика и остатки | Manager+ |
