	...
	>
		...
		>
				...
				>
					...
					>
						<div class=" self-center flex items-center justify-center size-9">
							<img
								src="{WEBUI_BASE_URL}/static/favicon.png?t=1737033600"
			...
			<div class="-mt-[0.5px]">
				...
				<!-- Files кнопка для сжатой панели -->
				<div class="">
				...
				{#if $user?.role === 'admin' || $user?.permissions?.workspace?.knowledge || $user?.permissions?.workspace?.prompts || $user?.permissions?.workspace?.tools}
					<div class="">
