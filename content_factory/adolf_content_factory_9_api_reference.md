# ADOLF Content Factory REST API Справочник (v1.8.4)
...
**Swagger UI:** `GET /docs`
**Версия приложения:** `1.8.27` (см. `app/config.py::APP_VERSION`)
