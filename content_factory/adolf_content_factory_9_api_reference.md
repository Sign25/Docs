...
> `rating_count` (оценки) и `reviews_count` (отзывы) — независимые числа из разных источников: можно поставить оценку, не написав отзыв, поэтому значения часто различаются.
